<template>
  <div class="col-md-12">
    ...
    <div v-if="!ArchivoTemporal.url && !isUploading" class="file-input-wrapper b-gray rounded-1 py-2 text-center w-100">
    ...
    <div v-else class="d-flex px-3 alert alert-secondary mt-1 mb-1">
...
// const archivo = ref<Adjunto>({ ...props.archivoTemporal });
