<template>
  ...
  <header id="home" class="bg-blue-600">
    <!-- [ Nav ] start -->
    <nav class="navbar bgdegradado_blue navbar-expand-md ">
      <div class="container">
...
<!-- 
            <li class="nav-item  px-1">
              <router-link to="/beneficios/" class="nav-link text-hover-info text-light f-16 d-flex">
                <i class="fa fa-caret-right f-18  p-r-5 align-content-center mb-0"></i> Portal Beneficios
              </router-link>
            </li>
             -->
            ...
            <li class="nav-item f-16  px-1">
              <router-link  to="/beneficios/negocio" class="nav-link  text-hover-info text-light  d-flex">
                <i class="fa fa-caret-right p-r-5 align-content-center"></i>Afiliados
              </router-link>
            </li>
            ...
            <!-- <li class="nav-item f-16  px-1" v-if="Usuario.idrol === 2">
              <router-link to="/beneficios/cumple" class="nav-link text-hover-info text-light d-flex">
                <i class="fa fa-caret-right p-r-5 align-content-center"></i>Cumpleaños
              </router-link>
            </li> -->

          </ul>
          <ul class="navbar-nav mb-2 mb-lg-0 align-items-start">
            <!-- <li v-if="isLoggedIn" class="nav-item align-content-center m-auto text-white">
            ...
            <!-- <li class="nav-item" v-else>
              ...
              <router-link  
                v-else
                to="/office" class="nav-link text-white f-18 ">
                <i class="ph-duotone ph-user"></i>
              </router-link>
            </li> -->
  ...
  <div class="offcanvas-body customer-body">
    ...
    <ul class="navbar-nav text-white me-auto p-l-20 mb-2 mb-lg-0 align-items-start ">
      ...
      <li class="nav-item f-16">
        <router-link  to="/beneficios/ofertas" class="nav-link text-white d-flex " >
          <div data-bs-dismiss="offcanvas">
            <i class="fa fa-caret-right p-r-5 align-content-center"></i>Descuentos
          </div>
        </router-link>
      ...
      <li class="nav-item f-16">
        <router-link  to="/beneficios/negocio" class="nav-link text-white d-flex">
          <div data-bs-dismiss="offcanvas">
            <i class="fa fa-caret-right p-r-5 align-content-center"></i>Afiliados
          </div>
        </router-link>
      ...
      <li class="nav-item f-16">
        <router-link  to="/beneficios/novedades" class="nav-link text-white d-flex">
          <div data-bs-dismiss="offcanvas">
            <i class="fa fa-caret-right p-r-5 align-content-center"></i>Novedades
          </div>
        </router-link>
      ...
      <li class="nav-item f-16 pt-5">
          <div @click="Loggin" class="btn-warning bg-yellow-800 border-0 btn mb-2 w-100 d-flex flex-wrap">
            <i class="ph-duotone ph-lock  p-r-10"></i> 
            Iniciar Sesión
          </div>
        </li>
      ...
      <!-- <div v-if="isLoggedIn">
        ...
        <li class="nav-item f-16">
          <router-link :to="{ name: 'MisFamiliares'}" class="nav-link text-white d-flex">
            <div data-bs-dismiss="offcanvas">
              <i class="fa fa-caret-right p-r-5 align-content-center"></i>Mis Familiares
            </div>
          </router-link>
        </li>
       -->
        <!-- ---------------- -->
        <!-- <li  v-if="isLoggedIn"  class="nav-item f-16">
          <router-link :to="{ name: 'MisCupones'}" class="nav-link text-white d-flex">
            <div data-bs-dismiss="offcanvas">
              <i class="fa fa-caret-right p-r-5 align-content-center"></i>Mis Cupones
            </div>
          </router-link>
        </li> -->
        ...
        <!-- ---------------- -->
        <!-- <li  v-if="isLoggedIn"  class="nav-item f-16">
          <router-link :to="{ name: 'MisCuponesUsados'}" class="nav-link text-white d-flex">
            <div data-bs-dismiss="offcanvas">
              <i class="fa fa-caret-right p-r-5 align-content-center"></i>Historial
            </div>
          </router-link>
        </li> -->
        ...
        <!-- ---------------- -->
        <!-- <li  v-if="isLoggedIn"  class="nav-item f-16">
          <router-link  to="/beneficios/carrito" class="nav-link text-white">
            <div data-bs-dismiss="offcanvas">
              <i class="fa fa-caret-right  p-r-5 "></i> Carrito de Cupones
              <span class="badge bg-danger">{{ carritoStore.ListaOfertas.length }}</span>
            </div>
          </router-link>
        </li> -->
        ...
        <!-- ---------------- -->
        <!-- <li class="nav-item f-16 pt-5">
          <div @click="confirmLogout" class="btn-warning bg-yellow-800 border-0 btn mb-2 w-100 d-flex flex-wrap">
            <i class="ph-duotone ph-lock  p-r-10"></i> 
            Cerrar Sesión
          </div>
        </li>
...
.bgdegradado_blue{
  background: rgb(7,28,144);
background: linear-gradient(90deg, rgba(7,28,144,1) 0%, rgba(16,42,184,1) 50%, rgba(15,83,199,1) 100%);
}
</style>
