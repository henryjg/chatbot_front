<template>
  <div class="row bg-blue-800" style="min-height: calc(100vh - 124px)">
    ...
    <div class="col-md-4 justify-content-center align-content-center">
      <div class="p-5">
        <div class="text-center">
            <h3 class="f-w-500 mb-1 text-info">Iniciar Sesión Negocio</h3>
    ...
    <div class="mb-3">
      ...
      <input type="text" v-model="usuario" class="form-control bg-white text-dark" placeholder="Ingrese su RUC">
    </div>
    <div class="mb-3">
